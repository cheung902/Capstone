var d = new Date().getTime();
        console.log(d);
        document.getElementById("comp_sample").src = "viewer/web/viewer.html?file=comp_sample.pdf?rnd=" + d;
        document.getElementById("ori_sample").src = "viewer/web/viewer.html?file=ori_sample.pdf?rnd=" + d;
...
$("#comp_sample").on('load', function(){

    $("#comp_sample").contents().find("#viewerContainer").on('scroll', function(){ 
      $("#ori_sample").contents().find("#viewerContainer").scrollTop($(this).scrollTop());
    });
    
    });
    
    
    $("#ori_sample").on('load', function(){
    $("#ori_sample").contents().find("#viewerContainer").on('scroll', function(){ 
     $("#comp_sample").contents().find("#viewerContainer").scrollTop($(this).scrollTop());
     });
    });