...
@ref_page.route('/viewer/web/annotate_compare.html')
def annotate_compare_Html():
	return render_template('viewer/web/annotate_compare.html')


@ref_page.route('/viewer/web/annotate_compare.js')
def annotate_compare_Js():
	return send_from_directory(ref_page.root_path, 'templates/viewer/web/annotate_compare.js')


@ref_page.route('/viewer/web/annotate_compare.css')
def annotate_compare_Css():
	return send_from_directory(ref_page.root_path, 'templates/viewer/web/annotate_compare.css')


@ref_page.route('/viewer/web/annotate_original.html')
def annotate_original_Html():
	return render_template('viewer/web/annotate_original.html')


@ref_page.route('/viewer/web/annotate_original.js')
def annotate_original_Js():
	return send_from_directory(ref_page.root_path, 'templates/viewer/web/annotate_original.js')


@ref_page.route('/viewer/web/annotate_original.css')
def annotate_original_Css():
	return send_from_directory(ref_page.root_path, 'templates/viewer/web/annotate_original.css')
...
def toolbarButton_secondaryToolbarToggle():
	return send_from_directory(ref_page.root_path,
							   'templates/viewer/web/images/toolbarButton-secondaryToolbarToggle.svg')
...
def secondaryToolbarButton_documentProperties():
	return send_from_directory(ref_page.root_path,
							   'templates/viewer/web/images/secondaryToolbarButton-documentProperties.svg')
